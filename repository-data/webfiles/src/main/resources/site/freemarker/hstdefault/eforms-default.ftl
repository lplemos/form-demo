...
<@hst.headContribution keyHint="formValidationCss">
  <link rel="stylesheet" href="<@hst.webfile path="js/formcheck/theme/blue/formcheck.css"/>" type="text/css" />
</@hst.headContribution>

<@hst.headContribution keyHint="jqueryUICss">
  <link rel="stylesheet" href="<@hst.webfile path="css/jquery-ui-1.10.2.custom.min.css"/>" type="text/css" />
</@hst.headContribution>

<@hst.headContribution keyHint="jqueryDatetimePickerCss">
  <link rel="stylesheet" href="<@hst.webfile path="css/jquery.datetimepicker-2.3.7.min.css"/>" type="text/css" />
</@hst.headContribution>
...
<@hst.headContribution keyHint="jquery-datetimepicker">
  <script type="text/javascript" src="<@hst.webfile path="js/jquery.datetimepicker.full-2.3.7.min.js"/>"></script>
</@hst.headContribution>

<@hst.headContribution keyHint="formJsValidation">
  <script type="text/javascript" src="<@hst.webfile path="js/jquery-validate-1.1.2.min.js"/>"></script>
</@hst.headContribution>

<@hst.headContribution keyHint="formJsValidationHippo">
  <script type="text/javascript" src="<@hst.webfile path="js/jquery-hippo-validate.js"/>"></script>
</@hst.headContribution>
          ...
          function(data){
            ...
            if (data) {
              for (var fieldName in data) {
                ...
                if (errorMessage) {
                  // add error message to feedback panel
                  messagesList.append('<li data-field-name="'+fieldName+'">' + errorMessage.localizedMessage + '</li>');
                  count++;
                }
              }
            }
